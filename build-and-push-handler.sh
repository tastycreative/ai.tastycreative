...
echo "   • 💾 NEW: Network volume storage for generated images"
echo "   • 🗂️  NEW: User-specific output folders (/runpod-volume/outputs/{userId}/)"
echo "   • 📉 NEW: Reduced database storage consumption"
echo ""
