    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <nav className="relative z-50 flex items-center justify-between p-6 md:p-8">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold">Creative Ink</span>
        </div>
      ...
      >
        <div className="text-center">
          {/* Badge */}
          <div className="inline-flex items-center space-x-2 bg-gray-900/50 border border-gray-800 rounded-full px-4 py-2 mb-8 backdrop-blur-sm">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={index}
              className="group bg-gray-900/30 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 hover:bg-gray-900/50 transition-all duration-300 backdrop-blur-sm"
            >
      ...
      <div className="absolute top-3/4 right-20 w-32 h-32 bg-purple-500/10 rounded-full blur-2xl animate-pulse delay-1000" />
      <div className="absolute bottom-1/4 left-1/3 w-16 h-16 bg-pink-500/10 rounded-full blur-lg animate-pulse delay-500" />
    </div>
  );
}
