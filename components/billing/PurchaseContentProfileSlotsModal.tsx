...
interface PurchaseContentProfileSlotsModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function PurchaseContentProfileSlotsModal({
  isOpen,
  onClose,
  onPurchase,
  pricePerSlot,
  ...
  baseLimit,
  purchasing = false,
}: PurchaseContentProfileSlotsModalProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-brand-mid-pink/10 dark:bg-brand-mid-pink/20 rounded-xl">
                <User className="w-6 h-6 text-brand-mid-pink" />
              </div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                Add Content Profile Slots
              </h2>
            </div>
            <button
              onClick={onClose}
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li className="flex items-start gap-2">
                  ...
                  <span>Create more AI content profiles</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-5 h-5 rounded-full bg-brand-mid-pink/10 dark:bg-brand-mid-pink/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <div className="w-2 h-2 rounded-full bg-brand-mid-pink" />
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    <div>
                      <p className="text-sm font-medium text-gray-900 dark:text-white">Additional Content Profile Slots</p>
