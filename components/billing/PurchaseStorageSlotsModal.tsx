...
import { X, HardDrive, Plus, Minus } from 'lucide-react';

interface PurchaseStorageSlotsModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function PurchaseStorageSlotsModal({
  isOpen,
  onClose,
  onPurchase,
  pricePerGB,
  ...
  baseStorageGB,
  purchasing = false,
}: PurchaseStorageSlotsModalProps) {
  const [quantity, setQuantity] = useState(5); // Default to 5GB
  ...
  const totalPrice = pricePerGB * quantity;
  const newTotalStorage = baseStorageGB + currentAdditionalGB + quantity;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-brand-mid-pink/10 dark:bg-brand-mid-pink/20 rounded-xl">
                <HardDrive className="w-6 h-6 text-brand-mid-pink" />
              </div>
          ...
          <div className="md:col-span-3 p-8 space-y-8 border-r border-gray-200 dark:border-gray-700">
            ...
            <div>
              <label className="block text-base font-semibold text-gray-900 dark:text-white mb-5">
                How much storage would you like to add?
              </label>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex-1 relative">
                  ...
                  <div className="absolute -bottom-6 left-0 right-0 text-center text-xs text-gray-500 dark:text-gray-500">
                    ${(pricePerGB * quantity).toFixed(2)}/month for {quantity} GB
                  </div>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li className="flex items-start gap-2">
                  ...
                  <span>Store more images, videos, and vault files</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-5 h-5 rounded-full bg-brand-mid-pink/10 dark:bg-brand-mid-pink/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <div className="w-2 h-2 rounded-full bg-brand-mid-pink" />
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>Storage persists across plan changes</span>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    <div>
                      <p className="text-sm font-medium text-gray-900 dark:text-white">Additional Storage</p>
                      <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">${pricePerGB.toFixed(2)}/month per GB</p>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 dark:text-white">× {quantity} GB</p>
                  </div>
                ...
                <div className="mt-6 p-4 bg-brand-blue dark:bg-brand-blue/20 rounded-xl border border-brand-blue dark:border-brand-blue">
                  <p className="text-xs font-semibold text-brand-blue dark:text-brand-blue mb-2">Billing Details</p>
