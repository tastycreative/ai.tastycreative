        ...
        <div className="bg-white dark:bg-white/5 border border-[#EC67A1]/20 rounded-xl p-5 sm:p-6 shadow-xl hover:shadow-2xl hover:scale-105 backdrop-blur-sm transition-all duration-300">
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              <h3 className="text-xs sm:text-sm font-semibold text-[#EC67A1] uppercase tracking-wide">Credits</h3>
              <p className="text-3xl sm:text-4xl font-bold text-zinc-900 dark:text-white mt-2">25</p>
            </div>
            <div className="p-2 bg-gradient-to-br from-[#EC67A1] to-[#F774B9] rounded-lg shadow-lg">
              <CreditCard className="w-5 h-5 text-white" />
            </div>
          </div>
          <button className="w-full bg-gradient-to-r from-[#EC67A1] to-[#F774B9] hover:from-[#F774B9] hover:to-[#EC67A1] text-white py-2 px-4 rounded-lg text-sm font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
            Add Credits
          </button>
        </div>
