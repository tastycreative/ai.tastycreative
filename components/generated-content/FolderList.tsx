...
export function FolderList({ onFolderSelect, selectedFolder }: FolderListProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden backdrop-blur-sm">
      ...
      <div className="relative p-4 sm:p-6 border-b border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent">
                  My Workspace
                </h3>
                <p className="text-xs text-gray-600 dark:text-gray-400 flex items-center gap-1 sm:gap-1.5">
            ...
            <div className="flex gap-1.5 sm:gap-2">
              <button
                ...
                disabled={loading}
                className="p-2 sm:p-2.5 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl transition-all duration-200 disabled:opacity-50 group active:scale-95"
                title="Refresh folders"
              >
                <RefreshCw className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${loading ? "animate-spin" : "group-hover:rotate-180 transition-transform duration-500"}`} />
              </button>
              <FolderManager 
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="block w-full pl-9 sm:pl-11 pr-8 sm:pr-10 py-2.5 sm:py-3 border border-gray-300/50 dark:border-gray-600/50 rounded-xl bg-white/80 dark:bg-gray-700/50 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-200 text-xs sm:text-sm shadow-sm hover:shadow-md backdrop-blur-sm"
            />
            {searchQuery && (
              <button
                onClick={() => setSearchQuery("")}
                className="absolute inset-y-0 right-0 pr-2 sm:pr-3 flex items-center text-gray-400 hover:text-red-500 transition-colors active:scale-95"
              >
      ...
      {/* Content */}
      <div className="p-3 sm:p-4 max-h-[500px] sm:max-h-[600px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
        {error && (
