...
const TableRow = React.memo(function TableRow({ model, onEdit, onDelete, onModelClick }: TableRowProps) {
      ...
      <td className="py-4 px-5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-white">
            {formatCurrency((model as any).guaranteedAmount)}
          </span>
        </div>
      </td>
...
export const OfModelsTable = React.memo(function OfModelsTable({
  models,
  onEdit,
  onDelete,
  onModelClick
    ...
    return [...models].sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case 'guaranteedAmount':
          comparison = ((a as any).guaranteedAmount || 0) - ((b as any).guaranteedAmount || 0);
          break;
        case 'createdAt':
