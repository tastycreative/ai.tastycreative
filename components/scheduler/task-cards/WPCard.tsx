    ...
    return (
      <>
        <div
          ...
          className={`flex items-center gap-2 rounded-lg border p-2 cursor-pointer transition-all hover:shadow-md hover:border-sky-300 dark:hover:border-sky-800/40 bg-white dark:bg-[#0c0c1a] ${
            isFlagged
