    ...
    return (
      <>
        <div
          ...
          className="flex items-center gap-2 rounded-lg border p-2 cursor-pointer transition-all hover:shadow-md hover:border-sky-300 dark:hover:border-sky-800/40 bg-white dark:bg-[#0c0c1a] border-gray-200 dark:border-[#111124]"
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              {fields.postSchedule && (
                <span className="text-[9px] font-mono text-sky-400 dark:text-sky-500 shrink-0">{fields.postSchedule}</span>
              )}
            ...
            {(fields.tag || fields.priceInfo) && (
              <div className="flex items-center gap-1.5 mt-0.5">
                {fields.tag && (
                  <span className="text-[8px] font-mono px-1 rounded bg-sky-50 text-sky-500 dark:bg-sky-900/20 dark:text-sky-400">{fields.tag}</span>
                )}
                {fields.priceInfo && (
                  <span className="text-[9px] font-mono text-sky-400">{fields.priceInfo}</span>
                )}
              </div>
            )}
          </div>
