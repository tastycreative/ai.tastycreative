...
export default function ContentPipelineView({ profileId }: ContentPipelineViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-pink-500/50 focus:ring-2 focus:ring-pink-500/20 transition-all"
          />
        </div>
        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value)}
          className="px-4 py-3 bg-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl text-white focus:outline-none focus:border-pink-500/50 focus:ring-2 focus:ring-pink-500/20 transition-all"
        >
      ...
      {/* Pipeline Table */}
      <div className="bg-gradient-to-br from-[#1a1a1a] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-2xl overflow-hidden shadow-2xl">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gradient-to-r from-pink-600/10 via-purple-600/10 to-blue-600/10 border-b-2 border-[#2a2a2a]">
              <tr>
                ...
                <tr>
                  <td colSpan={5} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center gap-4">
                      <div className="p-6 rounded-2xl bg-gradient-to-br from-pink-600/10 to-purple-600/10 border-2 border-pink-500/20">
                        <Sparkles className="w-16 h-16 text-pink-400" />
                      </div>
                      <div>
                        <p className="text-white font-semibold text-lg mb-1">No content yet</p>
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <div className="p-2 rounded-lg bg-gradient-to-br from-pink-600/20 to-purple-600/20 border border-pink-500/30 group-hover:border-pink-500/50 transition-all">
                            <Tag className="w-4 h-4 text-pink-400" />
                          </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-gray-300">{item.contentType}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-2 hover:bg-blue-600/20 rounded-lg transition-all border border-transparent hover:border-blue-500/30 group/btn"
                            title="View Details"
                          >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)] space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl text-sm disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                  >
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Date Created</label>
                <input
                  type="date"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
            </div>
            ...
            <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-xl font-medium transition-all"
              >
      ...
      {showViewModal && viewingItem && typeof window !== "undefined" && createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div
            className="relative bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden border-2 border-[#2a2a2a]"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="relative bg-gradient-to-r from-pink-600 via-purple-600 to-blue-600 p-5 text-white">
              <button
                onClick={() => setShowViewModal(false)}
              ...
              {viewingItem.reelSlot ? (
                <>
                  ...
                  {viewingItem.reelSlot.awsS3Url && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-purple-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-3">
                        <Video className="w-4 h-4 text-purple-400" />
                        <h4 className="font-bold text-white text-sm">Video Preview</h4>
                      </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 space-y-3 hover:border-purple-500/30 transition-all">
                      <div className="flex items-center gap-2 pb-2 border-b border-[#2a2a2a]">
                        <Video className="w-4 h-4 text-purple-400" />
                        <h4 className="font-bold text-white text-sm">Reel Details</h4>
                      </div>
                      <div className="space-y-2">
                        <div>
                          <p className="text-xs font-bold text-purple-400 uppercase tracking-wide mb-1">Reel Type</p>
                          <p className="text-white text-sm">{viewingItem.reelSlot.reelType}</p>
                        </div>
                        {viewingItem.reelSlot.hookIdea && (
                          <div>
                            <p className="text-xs font-bold text-pink-400 uppercase tracking-wide mb-1 flex items-center gap-1">
                              <TrendingUp className="w-3 h-3" />
                              Hook Idea
                            </p>
                            <p className="text-white text-sm">{viewingItem.reelSlot.hookIdea}</p>
                          </div>
                        )}
                        {viewingItem.reelSlot.trendingAudio && (
                          <div>
                            ...
                            <p className="text-white text-sm">{viewingItem.reelSlot.trendingAudio}</p>
                          </div>
                        )}
                      </div>
                    </div>

                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 space-y-3 hover:border-green-500/30 transition-all">
                      <div className="flex items-center gap-2 pb-2 border-b border-[#2a2a2a]">
                        <Clock className="w-4 h-4 text-green-400" />
                        <h4 className="font-bold text-white text-sm">Schedule Info</h4>
                      </div>
                      <div className="space-y-2">
                        <div>
                  ...
                  {viewingItem.reelSlot.caption && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-purple-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm">Caption</h4>
                      </div>
                      <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-wrap bg-[#1a1a1a] rounded-lg p-3 border border-[#2a2a2a]">
                        {viewingItem.reelSlot.caption}
                      </p>
                    </div>
                  )}
                  ...
                  {viewingItem.reelSlot.hashtags && viewingItem.reelSlot.hashtags.length > 0 && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-blue-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        <Hash className="w-4 h-4 text-blue-400" />
                        <h4 className="font-bold text-white text-sm">Hashtags</h4>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        {viewingItem.reelSlot.hashtags.map((tag, i) => (
                          <span
                            key={i}
                            className="text-xs px-3 py-1.5 bg-blue-900/30 text-blue-400 rounded-full border border-blue-500/30 font-medium"
                          >
                            {tag}
                          </span>
                        ))}
                  ...
                  {viewingItem.reelSlot.notes && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-yellow-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        <FileText className="w-4 h-4 text-yellow-400" />
                        <h4 className="font-bold text-white text-sm">Notes & Ideas</h4>
                      </div>
                      <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-wrap bg-[#1a1a1a] rounded-lg p-3 border border-[#2a2a2a]">
                        {viewingItem.reelSlot.notes}
                      </p>
                ...
                <>
                  ...
                  {(viewingItem.storySlot.awsS3Url || viewingItem.storySlot.linkedPost?.awsS3Url) && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-pink-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-3">
                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-pink-600/20 to-purple-600/20 border border-pink-500/30">
                          <ImageIcon className="w-4 h-4 text-pink-400" />
                        </div>
                        <h4 className="font-bold text-white text-sm">Story Media</h4>
                      </div>
                      <div className="flex justify-center bg-[#0a0a0a] rounded-lg p-3">
                  ...
                  {/* Story Details Grid */}
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 space-y-3 hover:border-blue-500/30 transition-all">
                      <div className="flex items-center gap-2 pb-2 border-b border-[#2a2a2a]">
                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-blue-500/30">
                          <Clock className="w-4 h-4 text-blue-400" />
                        </div>
                        <h4 className="font-bold text-white text-sm">Story Details</h4>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between p-2 rounded-lg bg-[#1a1a1a] border border-[#2a2a2a]">
                          <span className="text-gray-400 text-xs">Time Slot</span>
                          <span className="font-bold text-white text-sm">
                            {viewingItem.storySlot.timeSlot ? format(new Date(viewingItem.storySlot.timeSlot), "h:mm a") : "No time set"}
                          </span>
                        </div>
                        <div className="flex items-center justify-between p-2 rounded-lg bg-[#1a1a1a] border border-[#2a2a2a]">
                          <span className="text-gray-400 text-xs">Story Type</span>
                          <span className="font-bold text-white text-sm">
                    ...
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 space-y-3 hover:border-green-500/30 transition-all">
                      <div className="flex items-center gap-2 pb-2 border-b border-[#2a2a2a]">
                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-green-600/20 to-blue-600/20 border border-green-500/30">
                          <Calendar className="w-4 h-4 text-green-400" />
                        </div>
                        <h4 className="font-bold text-white text-sm">Publishing Info</h4>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between p-2 rounded-lg bg-[#1a1a1a] border border-[#2a2a2a]">
                        ...
                        <div className="flex items-center justify-between p-2 rounded-lg bg-[#1a1a1a] border border-[#2a2a2a]">
                          <span className="text-gray-400 text-xs">Posted Status</span>
                          <span className={`font-bold text-sm ${viewingItem.storySlot.isPosted ? 'text-green-400' : 'text-gray-400'}`}>
                            {viewingItem.storySlot.isPosted ? '✓ Yes' : '✗ No'}
                          </span>
                        </div>
                        {viewingItem.storySlot.postedAt && (
                          <div className="flex items-center justify-between p-2 rounded-lg bg-[#1a1a1a] border border-[#2a2a2a]">
                            <span className="text-gray-400 text-xs">Posted At</span>
                            <span className="font-bold text-white text-sm">
                  ...
                  {viewingItem.storySlot.caption && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-purple-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/30">
                  ...
                  {viewingItem.storySlot.hashtags && viewingItem.storySlot.hashtags.length > 0 && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-blue-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border border-blue-500/30">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {viewingItem.storySlot.hashtags.map((tag, index) => (
                          <span
                            key={index}
                            className="px-2.5 py-1 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 border border-blue-500/30 text-blue-300 rounded-lg text-xs font-medium hover:border-blue-500/50 transition-all"
                          >
                            {tag}
                          </span>
                        ))}
                  ...
                  {viewingItem.storySlot.notes && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-yellow-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm">Notes</h4>
                      </div>
                      <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-wrap bg-[#1a1a1a] rounded-lg p-3 border border-[#2a2a2a]">
                        {viewingItem.storySlot.notes}
                      </p>
                ...
                <>
                  ...
                  {viewingItem.feedPostSlot.files && viewingItem.feedPostSlot.files.length > 0 && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-blue-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <h4 className="font-bold text-white text-sm">Media Files ({viewingItem.feedPostSlot.files.length})</h4>
                      </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-blue-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm">Post Type</h4>
                      </div>
                      <p className="text-base font-semibold text-white">{viewingItem.feedPostSlot.postType.replace('_', ' ')}</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-purple-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm">Scheduled</h4>
                      </div>
                    ...
                    {viewingItem.feedPostSlot.location && (
                      <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-green-500/30 transition-all">
                        <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-sm text-gray-300">{viewingItem.feedPostSlot.location}</p>
                      </div>
                    )}
                    ...
                    {viewingItem.feedPostSlot.isPosted && viewingItem.feedPostSlot.postedAt && (
                      <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-green-500/30 transition-all">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h4 className="font-bold text-white text-sm">Posted</h4>
                        </div>
                        <p className="text-sm text-gray-300">
                  ...
                  {viewingItem.feedPostSlot.caption && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-cyan-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-cyan-600/20 to-blue-600/20 border border-cyan-500/30">
                  ...
                  {viewingItem.feedPostSlot.hashtags && viewingItem.feedPostSlot.hashtags.length > 0 && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-purple-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm">Hashtags ({viewingItem.feedPostSlot.hashtags.length})</h4>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        {viewingItem.feedPostSlot.hashtags.map((tag, index) => (
                          <span key={index} className="px-2.5 py-1 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 text-purple-300 rounded-lg text-xs font-medium">
                            {tag}
                          </span>
                        ))}
                      </div>
                  ...
                  {viewingItem.feedPostSlot.collaborators && viewingItem.feedPostSlot.collaborators.length > 0 && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 hover:border-pink-500/30 transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-pink-600/20 to-rose-600/20 border border-pink-500/30">
                          <Users className="w-4 h-4 text-pink-400" />
                        </div>
                        <h4 className="font-bold text-white text-sm">Collaborators ({viewingItem.feedPostSlot.collaborators.length})</h4>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        {viewingItem.feedPostSlot.collaborators.map((collab, index) => (
                          <span key={index} className="px-2.5 py-1 bg-gradient-to-r from-pink-600/20 to-rose-600/20 border border-pink-500/30 text-pink-300 rounded-lg text-xs font-medium">
                            {collab}
                          </span>
                        ))}
                      </div>
                ...
                <>
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4 space-y-2">
                  ...
                  {/* Notes */}
                  {viewingItem.notes && (
                    <div className="bg-gradient-to-br from-[#252525] to-[#1a1a1a] border-2 border-[#2a2a2a] rounded-xl p-4">
                      <h4 className="font-bold text-white text-sm mb-2">Notes</h4>
                      <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-wrap bg-[#1a1a1a] rounded-lg p-3">
                        {viewingItem.notes}
                      </p>
                    </div>
                  )}
            ...
            {/* Footer */}
            <div className="p-4 border-t-2 border-[#2a2a2a] flex justify-between bg-[#1a1a1a]">
              <button
              ...
              <button
                onClick={() => setShowViewModal(false)}
                className="px-5 py-2.5 bg-gradient-to-r from-[#2a2a2a] to-[#252525] hover:from-[#3a3a3a] hover:to-[#2a2a2a] text-white rounded-xl font-semibold transition-all border-2 border-[#3a3a3a] text-sm"
              >
                Close
              </button>
            </div>
