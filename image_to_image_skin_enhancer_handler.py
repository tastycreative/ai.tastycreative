...
def monitor_image_to_image_skin_enhancement_progress(prompt_id: str, job_id: str, webhook_url: str, user_id: str = 'unknown', workflow: Dict = None) -> Dict:
                                    ...
                                    for img_info in node_output['images']:
                                        ...
                                        if node_id == "38":  # SaveImage node
                                            ...
                                            if image_data_bytes:
                                                ...
                                                if workflow:
                                                    # Check SaveImage node (38) for filename_prefix
                                                    save_image_node = workflow.get('38', {})
...
def run_image_to_image_skin_enhancement_generation(job_input, job_id, webhook_url):
    ...
    try:
        ...
        result = monitor_image_to_image_skin_enhancement_progress(prompt_id, job_id, webhook_url, user_id, workflow)
