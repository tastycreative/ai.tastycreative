...
export async function seedFeaturePricing() {
  ...
  for (const feature of features) {
    await prisma.featureCreditPricing.upsert({
    ...
    console.log(`✓ Seeded: ${feature.featureName} (${feature.credits} credits)`);
  }

  console.log('Feature pricing seed completed!');
}
